...
In \cite{silver2016mastering}, the authors describe the functionality, methodology and achievments of Google DeepMind's \emph{Alpha Go} Go-game playing agent (as of 2015)
